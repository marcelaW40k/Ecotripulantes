...
import { setPublicationApi, upLoadImageApi } from '../api/publish'
...
export default {
    ...
    setup(props) {
        ...
        const publicationFormSchema = new Schema({
            materialType: {type: Object, required:[true, 'Seleccionar material']},
            prodImage: {type: Object, required:[true, 'Mínimo una imagen']},
            quantity: String,
            frecuency: String,
            address: String,
            cityLoc: String,
            deptLoc: String,
            description: {type: String, required:[true, 'Describa el material']},
        });*/
        const materialEnum = {
            mat1: 'paperBoard',
            mat2: 'paper',
        ...
        /*const publicationSchema = mongoose.model('PublishSet', publicationFormSchema);
        publicationSchema.export;*/
        ...
        let saveImage = () => {
            ...
            for (let i = 0; i < image.length; i++) {
                let file = image[i];
                imageData.append('files.prodImage', file, file.name);
            };
            console.log(image[0]);
        ...
        let setPublication = () => {
            ...
            //publicationForm.prodImage = imageData;
        ...
        const publish = async () => {
            ...
            try {
                ...
                // throw response;
                //alert(error.message);
                console.log(response.data.errors.materialType[0]);
            } catch (error) {
